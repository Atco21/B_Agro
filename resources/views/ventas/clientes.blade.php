...
@section('content3')
    <div class="m-2 p-5" id="clientesContainer">
  ...
  @foreach ($clientes as $cliente)
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalVerClienteLabel{{ $cliente->id }}">
        ...
        <div class="modal fade" id="modalEditarCliente{{ $cliente->id }}" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalEditarClienteLabel{{ $cliente->id }}">
                            Editar cliente
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{route('clientes.update', $cliente->id)}}" method="POST">
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="nombreCompleto{{ $cliente->id }}">
                                    Nombre completo
                                </label>
                                <input type="text" id="nombreCompleto{{ $cliente->id }}" name="nombre_completo"
                                    class="form-control" value="{{ $cliente->nombre_completo }}" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="dniNif{{ $cliente->id }}">
                                    DNI/NIF
                                </label>
                                <input type="text" id="dniNif{{ $cliente->id }}" name="dni_nif" class="form-control"
                                    value="{{ $cliente->dni_nif }}" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="direccion{{ $cliente->id }}">
                                    Dirección
                                </label>
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="telefono{{ $cliente->id }}">
                                    Teléfono
                                </label>
                                <input type="text" id="telefono{{ $cliente->id }}" name="telefono" class="form-control"
                                    value="{{ $cliente->telefono }}">
                            </div>
                            <div class="mb-3">
                                <label class="form-label" for="email{{ $cliente->id }}">
                                    Email
                                </label>
                                <input type="email" id="email{{ $cliente->id }}" name="email" class="form-control"
                                    value="{{ $cliente->email }}">
                            </div>
                            <div class="form-check mb-3">
                                <input type="checkbox" id="esEmpresa{{ $cliente->id }}" name="es_empresa"
                                    class="form-check-input" {{ $cliente->es_empresa ? 'checked' : '' }}>
                                <label class="form-check-label" for="esEmpresa{{ $cliente->id }}">
                                    Es empresa
                                </label>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('clientes.store')}}" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="dniNif">
                                DNI/NIF
                            </label>
